...
| --- | --- | --- | --- |
| Test suite duration | 1.87 s (254 tests), 279 cases passed | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 254 (240 unit / 14 integration), 279 cases passed | 100% green | `uv run pytest` (pre-commit framework + CI) |
