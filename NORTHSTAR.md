...
| --- | --- | --- | --- |
| Test suite duration | 1.87 s (259 tests), 284 cases passed | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 259 (245 unit / 14 integration), 284 cases passed | 100% green | `uv run pytest` (pre-commit framework + CI) |
