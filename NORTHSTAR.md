...
| --- | --- | --- | --- |
| Test suite duration | 1.87 s (252 tests), 277 cases passed | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 252 (238 unit / 14 integration), 277 cases passed | 100% green | `uv run pytest` (pre-commit framework + CI) |
