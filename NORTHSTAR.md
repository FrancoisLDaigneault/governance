...
| --- | --- | --- | --- |
| Test suite duration | 1.87 s (255 tests), 280 cases passed | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 255 (241 unit / 14 integration), 280 cases passed | 100% green | `uv run pytest` (pre-commit framework + CI) |
