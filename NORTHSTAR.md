...
| --- | --- | --- | --- |
| Test suite duration | 1.83 s (244 tests), 269 cases passed | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 244 (230 unit / 14 integration), 269 cases passed | 100% green | `uv run pytest` (pre-commit framework + CI) |
