...
| --- | --- | --- | --- |
| Test suite duration | 1.87 s (257 tests), 282 cases passed | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 257 (243 unit / 14 integration), 282 cases passed | 100% green | `uv run pytest` (pre-commit framework + CI) |
