...
| --- | --- | --- | --- |
| Test suite duration | 1.87 s (253 tests), 278 cases passed | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 253 (239 unit / 14 integration), 278 cases passed | 100% green | `uv run pytest` (pre-commit framework + CI) |
