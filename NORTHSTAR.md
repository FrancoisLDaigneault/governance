...
| --- | --- | --- | --- |
| Test suite duration | 1.87 s (256 tests), 281 cases passed | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 256 (242 unit / 14 integration), 281 cases passed | 100% green | `uv run pytest` (pre-commit framework + CI) |
