...
| --- | --- | --- | --- |
| Test suite duration | 2.8 s (200 tests) | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 200 (186 unit / 14 integration) | 100% green | `uv run pytest` (pre-commit framework + CI) |
